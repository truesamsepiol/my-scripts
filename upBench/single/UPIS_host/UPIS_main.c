...
static bool print_response_enabled = true;
...
void upis(int nr_dpus)
{
    ...
    unsigned int nb_mram = nr_dpus;
    unsigned int nb_loop = DEFAULT_LOOP;
    //char *mram_path = DEFAULT_MRAM_PATH;
    char *mram_path = "UPIS_datasets/integration2/mrams/";
    char *dict_path = "UPIS_datasets/wikipedia/dictionary/dict.txt";
    char *requests_path = "UPIS_datasets/wikipedia/requests/requests.txt";
    bool load_mram = true;
