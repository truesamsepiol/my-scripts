...
apps="fac.o sum.o BFS_app.o BS_app.o GEMV_app.o HST-L_app.o HST-S_app.o MPL_app.o NW_app.o RED_app.o SCAN-RSS_app.o SCAN-SSA_app.o SEL_app.o SpMV_app.o TRNS_app.o TS_app.o"
